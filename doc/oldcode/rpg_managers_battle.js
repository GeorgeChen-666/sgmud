...
/**
 * @param troopId   当交手对手为NPC时只使用第一个敌群，并将交手NPC添加到敌群中。
 * @param canEscape
 * @param canLose
 */
BattleManager.setup = function(troopId, canEscape, canLose,actorIds=[]) {debugger;
    this.initMembers();
    this._canEscape = canEscape;
    this._canLose = canLose;
    $gameTroop.setup(troopId,actorIds);
